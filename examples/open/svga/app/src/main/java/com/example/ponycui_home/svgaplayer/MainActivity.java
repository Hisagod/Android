...
public class MainActivity extends AppCompatActivity {
    ...
    void setupData() {
        this.items.add(new SampleItem("Animation From Java Code", new Intent(this, AnimationFromJavaCodeActivity.class)));
        ...
        this.items.add(new SampleItem("Animation From RecyclerView", new Intent(this, AnimationFromRecyclerViewActivity.class)));
