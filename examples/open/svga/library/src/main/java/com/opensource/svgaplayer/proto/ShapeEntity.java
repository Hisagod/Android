...
public final class ShapeEntity extends Message<ShapeEntity, ShapeEntity.Builder> {
    ...
    public ShapeEntity(ShapeType type, ShapeStyle styles, TransformEntity transform, ShapeArgs shape, RectArgs rect, EllipseArgs ellipse) {
        this(type, styles, transform, shape, rect, ellipse, ByteString.EMPTY);
    }

    public ShapeEntity(ShapeType type, ShapeStyle styles, TransformEntity transform, ShapeArgs shape, RectArgs rect, EllipseArgs ellipse, ByteString unknownFields) {
    ...
    private static final class ProtoAdapter_ShapeEntity extends ProtoAdapter<ShapeEntity> {
        ...
        public int encodedSize(ShapeEntity value) {
            return (value.type != null ? ShapeType.ADAPTER.encodedSizeWithTag(1, value.type) : 0)
                    ...
                    + (value.transform != null ? TransformEntity.ADAPTER.encodedSizeWithTag(11, value.transform) : 0)
        ...
        public void encode(ProtoWriter writer, ShapeEntity value) throws IOException {
            ...
            if (value.transform != null)
                TransformEntity.ADAPTER.encodeWithTag(writer, 11, value.transform);
