...
public final class FrameEntity extends Message<FrameEntity, FrameEntity.Builder> {
    ...
    public final LayoutEntity layout;
    ...
    public final TransformEntity transform;
    ...
    public FrameEntity(Float alpha, LayoutEntity layout, TransformEntity transform, String clipPath, List<ShapeEntity> shapes) {
        this(alpha, layout, transform, clipPath, shapes, ByteString.EMPTY);
    }

    public FrameEntity(Float alpha, LayoutEntity layout, TransformEntity transform, String clipPath, List<ShapeEntity> shapes, ByteString unknownFields) {
    ...
    public static final class Builder extends Message.Builder<FrameEntity, Builder> {
         ...
         * 初始约束大小
         */
        public Builder layout(LayoutEntity layout) {
            this.layout = layout;
            return this;
        }
         ...
         * 2D 变换矩阵
         */
        public Builder transform(TransformEntity transform) {
            this.transform = transform;
            return this;
        }
    ...
    private static final class ProtoAdapter_FrameEntity extends ProtoAdapter<FrameEntity> {
        ...
        public int encodedSize(FrameEntity value) {
            return (value.alpha != null ? ProtoAdapter.FLOAT.encodedSizeWithTag(1, value.alpha) : 0)
                    + (value.layout != null ? LayoutEntity.ADAPTER.encodedSizeWithTag(2, value.layout) : 0)
                    + (value.transform != null ? TransformEntity.ADAPTER.encodedSizeWithTag(3, value.transform) : 0)
        ...
        public void encode(ProtoWriter writer, FrameEntity value) throws IOException {
            ...
            if (value.layout != null) LayoutEntity.ADAPTER.encodeWithTag(writer, 2, value.layout);
            if (value.transform != null)
                TransformEntity.ADAPTER.encodeWithTag(writer, 3, value.transform);
            ...
            for (int tag; (tag = reader.nextTag()) != -1; ) {
                switch (tag) {
                    case 1:
                        ...
                        break;
                    case 2:
                        builder.layout(LayoutEntity.ADAPTER.decode(reader));
                        break;
                    case 3:
                        builder.transform(TransformEntity.ADAPTER.decode(reader));
                        break;
                    case 4:
        ...
        public FrameEntity redact(FrameEntity value) {
            ...
            if (builder.layout != null) builder.layout = LayoutEntity.ADAPTER.redact(builder.layout);
            if (builder.transform != null)
                builder.transform = TransformEntity.ADAPTER.redact(builder.transform);
