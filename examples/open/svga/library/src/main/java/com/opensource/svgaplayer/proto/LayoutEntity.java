...
public final class LayoutEntity extends Message<LayoutEntity, LayoutEntity.Builder> {
    public static final ProtoAdapter<LayoutEntity> ADAPTER = new ProtoAdapter_Layout();
    ...
    public LayoutEntity(Float x, Float y, Float width, Float height) {
        this(x, y, width, height, ByteString.EMPTY);
    }

    public LayoutEntity(Float x, Float y, Float width, Float height, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LayoutEntity)) return false;
        LayoutEntity o = (LayoutEntity) other;
    ...
    public static final class Builder extends Message.Builder<LayoutEntity, Builder> {
        public Float x;
        ...
        public LayoutEntity build() {
            return new LayoutEntity(x, y, width, height, super.buildUnknownFields());
        }
    }

    private static final class ProtoAdapter_Layout extends ProtoAdapter<LayoutEntity> {
        ProtoAdapter_Layout() {
            super(FieldEncoding.LENGTH_DELIMITED, LayoutEntity.class);
        }

        @Override
        public int encodedSize(LayoutEntity value) {
        ...
        @Override
        public void encode(ProtoWriter writer, LayoutEntity value) throws IOException {
        ...
        @Override
        public LayoutEntity decode(ProtoReader reader) throws IOException {
            Builder builder = new Builder();
        ...
        @Override
        public LayoutEntity redact(LayoutEntity value) {
