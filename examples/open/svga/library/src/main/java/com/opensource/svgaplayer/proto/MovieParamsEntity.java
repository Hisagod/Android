...
public final class MovieParamsEntity extends Message<MovieParamsEntity, MovieParamsEntity.Builder> {
    public static final ProtoAdapter<MovieParamsEntity> ADAPTER = new ProtoAdapter_MovieParams();
    ...
    public MovieParamsEntity(Float viewBoxWidth, Float viewBoxHeight, Integer fps, Integer frames) {
        this(viewBoxWidth, viewBoxHeight, fps, frames, ByteString.EMPTY);
    }

    public MovieParamsEntity(Float viewBoxWidth, Float viewBoxHeight, Integer fps, Integer frames, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MovieParamsEntity)) return false;
        MovieParamsEntity o = (MovieParamsEntity) other;
    ...
    public static final class Builder extends Message.Builder<MovieParamsEntity, Builder> {
        ...
        @Override
        public MovieParamsEntity build() {
            return new MovieParamsEntity(viewBoxWidth, viewBoxHeight, fps, frames, super.buildUnknownFields());
        }
    }

    private static final class ProtoAdapter_MovieParams extends ProtoAdapter<MovieParamsEntity> {
        ProtoAdapter_MovieParams() {
            super(FieldEncoding.LENGTH_DELIMITED, MovieParamsEntity.class);
        }

        @Override
        public int encodedSize(MovieParamsEntity value) {
        ...
        @Override
        public void encode(ProtoWriter writer, MovieParamsEntity value) throws IOException {
        ...
        @Override
        public MovieParamsEntity decode(ProtoReader reader) throws IOException {
            Builder builder = new Builder();
        ...
        @Override
        public MovieParamsEntity redact(MovieParamsEntity value) {
