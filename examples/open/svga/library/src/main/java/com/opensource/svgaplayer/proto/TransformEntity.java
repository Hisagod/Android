...
public final class TransformEntity extends Message<TransformEntity, TransformEntity.Builder> {
    public static final ProtoAdapter<TransformEntity> ADAPTER = new ProtoAdapter_Transform();
    ...
    public TransformEntity(Float a, Float b, Float c, Float d, Float tx, Float ty) {
        this(a, b, c, d, tx, ty, ByteString.EMPTY);
    }

    public TransformEntity(Float a, Float b, Float c, Float d, Float tx, Float ty, ByteString unknownFields) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TransformEntity)) return false;
        TransformEntity o = (TransformEntity) other;
    ...
    public static final class Builder extends Message.Builder<TransformEntity, Builder> {
        public Float a;
        ...
        public TransformEntity build() {
            return new TransformEntity(a, b, c, d, tx, ty, super.buildUnknownFields());
        }
    }

    private static final class ProtoAdapter_Transform extends ProtoAdapter<TransformEntity> {
        ProtoAdapter_Transform() {
            super(FieldEncoding.LENGTH_DELIMITED, TransformEntity.class);
        }

        @Override
        public int encodedSize(TransformEntity value) {
        ...
        @Override
        public void encode(ProtoWriter writer, TransformEntity value) throws IOException {
        ...
        @Override
        public TransformEntity decode(ProtoReader reader) throws IOException {
            Builder builder = new Builder();
        ...
        @Override
        public TransformEntity redact(TransformEntity value) {
